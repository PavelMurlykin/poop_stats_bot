"""Инициализация схемы PostgreSQL для всех доменных таблиц бота."""
...
def init_db(cursor) -> None:
    """Создаёт таблицы и индексы приложения при первом запуске.

    Args:
        cursor: Курсор PostgreSQL в рамках активной транзакции.
    """
